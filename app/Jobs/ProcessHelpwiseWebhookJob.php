...
class ProcessHelpwiseWebhookJob implements ShouldQueue
{
    ...
    public function handle(HelpwiseApiService $helpwiseApi, HelpwiseReplyAiService $aiService): void
    {
        ...
        try {
            ...
            // Generate AI reply
            $aiResult = $aiService->generateReply($threadMessages, $studentData);
