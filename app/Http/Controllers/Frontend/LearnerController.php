...
class LearnerController extends Controller
{
    ...
    {
        $calendarService = app(LearnerCalendarService::class);
        $events = $calendarService->formattedEventsForUser(Auth::user());
    ...
    {
        $calendarService = app(LearnerCalendarService::class);
        $events = $calendarService->eventsForUser(Auth::user());
    ...
    public function upgrade(Request $request): View
    {
        ...
        return view('frontend.learner.upgrade', compact('coursesTaken'));
    }
    ...
    public function projectStorageDetails($project_id, $registration_id)
    {
        ...
        $standardProject = Project::find($project_id);
        $projectCentralDistributions = $standardProject->registrations()
            ->where('field', 'central-distribution')
            ->where('in_storage', 1)
            ->get()
        ...
        $distribution = $projectCentralDistributions[0];
