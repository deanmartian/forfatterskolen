    ...
    public function up(): void
    {
        if (!Schema::hasTable('ad_campaigns')) {
            Schema::create('ad_campaigns', function (Blueprint $table) {
                ...
                $table->timestamps();
                $table->foreign('account_id')->references('id')->on('ad_accounts')->onDelete('cascade');
            });
        }
        ...
        if (!Schema::hasTable('ad_creatives')) {
            Schema::create('ad_creatives', function (Blueprint $table) {
                ...
                $table->timestamps();
                $table->foreign('variant_of')->references('id')->on('ad_creatives')->onDelete('set null');
            });
        }
        ...
        if (!Schema::hasTable('ad_ads')) {
            Schema::create('ad_ads', function (Blueprint $table) {
                ...
                $table->json('platform_meta')->nullable();
                $table->timestamps();
                $table->foreign('ad_set_id')->references('id')->on('ad_ad_sets')->onDelete('cascade');
                $table->foreign('creative_id')->references('id')->on('ad_creatives')->onDelete('set null');
            });
        }
        ...
        if (!Schema::hasTable('ad_creative_variants')) {
            Schema::create('ad_creative_variants', function (Blueprint $table) {
                ...
                $table->timestamps();
                $table->foreign('creative_id')->references('id')->on('ad_creatives')->onDelete('cascade');
                $table->foreign('parent_id')->references('id')->on('ad_creative_variants')->onDelete('set null');
            });
        }
    }
