...
class AiKnownIssueSeeder extends Seeder
{
    public function run(): void
    {
        $issues = [
            ...
            [
                'title' => '⭐ Be alltid kunder klikke "Tøm cookies og cache"-knappen øverst på siden (gjelder ALLE roller)',
                'description' => 'Vi har en synlig rød stripe øverst på hver side av BÅDE forfatterskolen.no (elever) OG editor.forfatterskolen.no (redaktører) — også på login-sidene — med en hvit knapp som heter "Tøm cookies og cache". Den ble lansert 08.04.2026 og rydder ALT for vår side: cookies, localStorage, sessionStorage, service workers, cache storage. Etter klikk blir brukeren automatisk redirectet til forsiden hvor de kan logge inn på nytt. KUN forfatterskolen-data slettes — ingenting på andre nettsider røres (Same-Origin Policy). Banneret fungerer helt likt for elever og redaktører — forskjellen er bare hvilken URL du sender dem til.',
                'workaround' => 'Når en kunde rapporterer ANY problem som kan relateres til cache, cookies, innlogging som henger, sider som ikke laster riktig, eller "rare" feilmeldinger — be dem ALLTID gjøre dette først (det tar 5 sekunder). For ELEVER: "Gå til forfatterskolen.no — helt øverst på siden ser du en rød stripe med en hvit knapp som heter Tøm cookies og cache — klikk den." For REDAKTØRER: "Gå til editor.forfatterskolen.no — også på login-siden hvis du ikke kommer inn — øverst er det en rød stripe med Tøm cookies og cache-knapp. Klikk den, så rydder det alt og du kan logge inn på nytt." Sjekk rollen i ELEVINFORMASJON før du velger URL. Hvis kunden har lukket banneret tidligere, er den skjult i 24 timer og de må enten bruke privat/inkognito-vindu eller åpne den igjen via cookies-clearing manuelt.',
                'severity' => 'high',
                'category' => 'innlogging',
            ],
            [
