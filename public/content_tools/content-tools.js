...
(function() {
  ...
  ContentTools = {
    ...
    getEmbedVideoURL: function(url) {
      ...
      domains = {
        ...
        'wistia.com': 'wistia',
        'post-forfatterskolen.wistia.com': 'wistia',
      };
      ...
      switch (domains[netloc]) {
        ...
        case 'wistia':
          ...
          return 'https://fast.wistia.net/embed/iframe/'+lastSegment+'?embedType=legacy_api&videoFoam=true&videoWidth=720&chromeless=false&controlsVisibleOnLoad=true&playbar=true&fullscreenButton=true&playerColor=ff0000';
      }
      return null;
    },
  ...
  ContentTools.VideoDialog = (function(_super) {
    ...
    VideoDialog.prototype.mount = function() {
      ...
      this._domInput.setAttribute('placeholder', ContentEdit._('Paste Wistia URL') + '...');
      this._domInput.setAttribute('type', 'text');
    ...
    VideoDialog.prototype.preview = function(url) {
      ...
      this._domPreview.setAttribute('allowfullscreen');
