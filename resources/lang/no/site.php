...
<p>Skriveglad hilsen fra Team Forfatterskolen</p>',
    ...
    array (
      ...
      'first-section' => 
      array (
        'description' => '<p class="mb-5">Er du usikker på om ideen og utkastet ditt kan bli en god fortelling? Står du fast med manuset, og lurer på hva som funker og ikke funker? Eller trenger du en tilbakemelding, og kvalitetssikring, før du sender inn til forlag? </p>
...
<p class="mb-0">Vi har hjulpet mange elever på vei mot utgivelse, og bistår gjerne flere. Er du den neste? Ikke nøl med å sende oss manuset ditt, det er slik du kommer videre!</p>',
