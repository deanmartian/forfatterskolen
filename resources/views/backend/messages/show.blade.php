...
<div class="ed-section">
    <div class="ed-section__header">
        <h2 class="ed-section__title">
            <a href="{{ route('admin.messages.index') }}" style="color: var(--ink-soft); text-decoration: none; margin-right: 8px;">
    ...
    <div class="panel panel-default">
        ...
        <div class="msg-reply">
            <form method="POST" action="{{ route('admin.messages.reply', $conversation->id) }}">
                {{ csrf_field() }}
