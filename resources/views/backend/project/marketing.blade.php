...
@section('content')
    ...
    <div class="col-sm-12 margin-top">
        ...
        <button type="button" class="btn btn-success">+ Add Application Cultural Council/Free Word</button>
        <div class="table-responsive margin-top">
            <table class="table table-side-bordered table-white">
                <thead>
                <tr>
                    <th>Application Cultural Council/Free Word</th>
                </tr>
                </thead>
                <tbody>
                </tbody>
        ...
        <button type="button" class="btn btn-success">+ Add Print/Ebook</button>
        <div class="table-responsive margin-top">
            <table class="table table-side-bordered table-white">
                <thead>
                <tr>
        ...
        <button type="button" class="btn btn-success">+ Add Sample book approved</button>
        <div class="table-responsive margin-top">
            <table class="table table-side-bordered table-white">
                <thead>
                <tr>
        ...
        <button type="button" class="btn btn-success">+ Add PDF is approved</button>
        <div class="table-responsive margin-top">
            <table class="table table-side-bordered table-white">
                <thead>
                <tr>
        ...
        <button type="button" class="btn btn-success">+ Add Number of books by author</button>
        <div class="table-responsive margin-top">
            <table class="table table-side-bordered table-white">
                <thead>
                <tr>
