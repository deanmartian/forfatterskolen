...
@page :left {
    ...
    @top-left { content:string(book-title); font-family:'Inter',sans-serif; font-size:var(--header-size-88); font-weight:300; letter-spacing:0.15em; text-transform:uppercase; color:#bbb; }
}
@page :right {
    @top-right { content:string(chapter-title); font-family:'Inter',sans-serif; font-size:var(--header-size-88); font-weight:300; letter-spacing:0.15em; text-transform:uppercase; color:#bbb; }
}
...
.titlepage h1 { font-family:'Inter',sans-serif; font-weight:600; font-size:var(--h1-size-110); letter-spacing:-0.01em; line-height:1.15; color:#111; margin-bottom:4mm; }
...
.toc li { font-size:var(--body-size-95); padding:2.5mm 0; display:flex; justify-content:space-between; align-items:baseline; color:#333; }
.toc li .page-num { font-family:'Inter',sans-serif; font-weight:300; font-size:8pt; color:#bbb; }

.chapter .chapter-number { font-family:'Inter',sans-serif; font-weight:300; font-size:8pt; letter-spacing:0.3em; text-transform:uppercase; color:#bbb; margin-top:var(--sink-115); margin-bottom:5mm; display:block; }
...
blockquote { font-style:italic; margin:5mm 0 5mm 5mm; color:#555; font-size:var(--body-size-95); }
