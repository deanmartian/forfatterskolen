...
.halftitle h1 { font-family:'Source Sans 3',sans-serif; font-weight:600; font-size:var(--h1-size-70); letter-spacing:0.1em; text-transform:uppercase; color:#2C3E50; }
...
.titlepage h1 { font-family:'Source Sans 3',sans-serif; font-weight:700; font-size:var(--h1-size-110); line-height:1.2; color:#111; margin-bottom:4mm; }
...
.toc h2 { font-family:'Source Sans 3',sans-serif; font-weight:700; font-size:14pt; color:#2C3E50; text-align:center; margin-top:var(--sink-70); margin-bottom:8mm; }
...
.toc li { font-size:var(--body-size-95); padding:1.5mm 0; display:flex; justify-content:space-between; }
...
.chapter .chapter-intro { font-family:'Merriweather',serif; font-style:italic; font-size:var(--body-size-95); color:#777; text-align:center; max-width:85%; margin:0 auto var(--chapter-ornament-margin); text-indent:0; line-height:1.5; }
...
.factbox p { font-size:var(--body-size-90); line-height:1.5; text-indent:0; color:#444; }
...
blockquote { font-style:italic; margin:5mm 8mm; padding-left:4mm; border-left:0.5pt solid #2C3E50; color:#555; font-size:var(--body-size-95); }
