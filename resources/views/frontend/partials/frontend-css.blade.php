...
<?php
    $newDesignPages = ['front.shop-manuscript.index', 'front.publishing', 'front.blog', 'front.shop.thankyou', 'front.thank-you',
        ...
        'front.course.claim-reward', 'front.free-webinar', 'front.free-webinar-thanks', 'front.terms' ,'auth.login.show',
        'front.henrik', 'learner.dashboard', 'learner.account.search', 'learner.course', 'learner.course.show',
