            ...
            @if(Auth::guest())
                ...
                <div style="display: flex; gap: 0.65rem; margin-bottom: 1.25rem;">
                    <a href="{{ route('auth.login.vipps', 'checkout_state') }}" class="co-vipps-btn" style="flex: 1; margin-bottom: 0; text-decoration: none;">
                        Logg inn med
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 421 106" style="height:22px;margin-left:4px;" fill="white">
                            <path d="M79.1 11.2L54.3 76.3c-1.5 3.8-4.6 5.7-8 5.7-3.5 0-6.5-1.9-8-5.7L13.4 11.2c-.7-1.5-1-2.9-1-4.1C12.4 3.3 15.8 0 20 0c3.7 0 6.4 2.1 7.8 5.5l21.7 51.3 21.7-51.3C72.7 2.1 75.3 0 79 0c4.2 0 7.6 3.3 7.6 7.1 0 1.2-.3 2.6-1 4.1h-6.5zM101.3 16.1c-4.8 0-8.5-3.7-8.5-8.4 0-4.7 3.7-8.4 8.5-8.4s8.5 3.7 8.5 8.4c0 4.7-3.7 8.4-8.5 8.4zm-7.1 68.5V24c0-4 3-7.1 7.1-7.1s7.1 3.1 7.1 7.1v60.6c0 4-3 7.1-7.1 7.1s-7.1-3.1-7.1-7.1zM166.1 42.3c0-12-7.1-19.4-17.3-19.4-10.2 0-17.7 8.4-17.7 19.4v42.3c0 4-3 7.1-7.1 7.1s-7.1-3.1-7.1-7.1V24c0-4 3-7.1 7.1-7.1 3.3 0 6 2.1 6.7 5.2 4.4-3.8 10.5-6.3 18.1-6.3 18.5 0 31.5 13.7 31.5 32.5v36.3c0 4-3 7.1-7.1 7.1s-7.1-3.1-7.1-7.1V42.3zM247.1 42.3c0-12-7.1-19.4-17.3-19.4-10.2 0-17.7 8.4-17.7 19.4v42.3c0 4-3 7.1-7.1 7.1s-7.1-3.1-7.1-7.1V24c0-4 3-7.1 7.1-7.1 3.3 0 6 2.1 6.7 5.2 4.4-3.8 10.5-6.3 18.1-6.3 18.5 0 31.5 13.7 31.5 32.5v36.3c0 4-3 7.1-7.1 7.1s-7.1-3.1-7.1-7.1V42.3zM310.1 15.9c22.5 0 37.7 17.8 37.7 38.2 0 4-3 7.1-7.1 7.1h-51.8c2.6 11 12 18.5 24.3 18.5 7.1 0 13-2.5 17.3-6.5 1.6-1.5 3.5-2.3 5.7-2.3 3.7 0 6.5 2.8 6.5 6.3 0 1.7-.7 3.4-2 4.8-6.3 6.5-15.7 11-28.1 11-23.2 0-38.4-17-38.4-38.6 0-21.6 15.9-38.5 35.9-38.5zm-21.2 31.8h43.6c-2.6-11.2-10.8-18.5-21.5-18.5-11.5 0-19.5 7.3-22.1 18.5zM376.1 15.9c7.4 0 14.1 2.3 19.3 6.3 1.9 1.5 2.8 3.4 2.8 5.5 0 3.7-3 6.7-6.7 6.7-1.6 0-3-.5-4.2-1.4-3.3-2.6-7-3.9-11.2-3.9-5.5 0-9 2.8-9 6.7 0 4.4 4.6 5.9 11.8 7.8l2.3.6c12.7 3.4 21.7 7.8 21.7 19.8 0 13.9-11.5 22.1-26.3 22.1-9.7 0-18.8-3.5-24.5-9.3-1.5-1.5-2.3-3.3-2.3-5.3 0-3.7 3-6.7 6.7-6.7 1.9 0 3.5.7 4.8 1.9 4 3.7 9.2 5.9 15.3 5.9 6.3 0 10.5-2.8 10.5-7.6 0-5-5.2-6.7-13.2-8.9l-2.3-.6c-11.2-3-20.3-7.8-20.3-19.1 0-12.5 10.8-21.5 24.8-21.5z"/>
                        </svg>
                    </a>
