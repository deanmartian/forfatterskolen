...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <form class="form-theme" method="POST" enctype="multipart/form-data" action="{{ route('front.shop-manuscript.upgrade-manuscript', ['id' => $shopManuscript->id]) }}">
                {{csrf_field()}}
                <div class="col-sm-12 col-md-8">
                    ...
                    <div class="panel panel-default no-margin-bottom">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="text-center margin-bottom checkout-total">
                                ...
                                <h4>Totalt</h4>
                                <span>{{ FrontendHelpers::currencyFormat($upgradeManuscript->price) }}</span>
                            </div>
