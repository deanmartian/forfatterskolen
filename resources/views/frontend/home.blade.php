            ...
            <div class="row upcoming-row">
                ...
                <div class="col-md-4">
                    <div class="column free-webinar" itemscope itemtype="http://schema.org/CreativeWork"
                         data-bg="https://www.forfatterskolen.no/images-new/langeland/henrik.jpg" style="    background-size: cover;
    background-position: 40%;
    background-repeat: no-repeat;">
                        {{--https://www.forfatterskolen.no/images-new/front-page/kristine.jpeg--}}
                        <div class="content-container">
                            ...
                            <div class="h2 mt-0 mb-4 font-montserrat-semibold">
                                Tre dagers online skrivekurs med Henrik Langeland
                            </div>
