...
@section('content')
	<div class="learner-container learner-invoice-wrapper" id="app-container">
        ...
        $receiptVatCents = $invoice->vat ?? 0;
        $receiptVatAmount = $receiptVatCents ? $receiptVatCents / 100 : 0;
        ...
        $receiptFields = [
                ...
                'total_vat_formatted' => $receiptVatFormatted,
                'vat_total_formatted' => $receiptVatFormatted,
                'net_total_formatted' => $receiptNetFormatted,
                'amount_due_formatted' => $receiptTotalFormatted,
        ...
        <div class="modal-dialog modal-lg">
                <div class="modal-content receipt-modal-content">
                        <div class="modal-header receipt-modal-header">
                                <button type="button" class="close receipt-modal-close" data-dismiss="modal" aria-label="{{ trans('site.close') }}">
                        ...
                        <div class="modal-body receipt-modal-body">
                                <div class="receipt-document">
                                        ...
                                        <div class="receipt-customer-row">
                                                <div class="receipt-customer">
                                                        <div class="receipt-company-address d-none">
                                                                ...
                                                                <div data-receipt-field="company-city"></div>
                                                                <div data-receipt-field="company-number"></div>
                                                        </div>
                                                        <div class="receipt-customer-address">
                                                                <div data-receipt-field="customer-name"></div>
                                                                <div data-receipt-field="customer-street"></div>
                                        ...
                                        <div class="receipt-totals">
                                                ...
                                                <div class="receipt-total-row">
                                                        <span>{{ trans('site.order-history.vat') }}</span>
                                                        <span data-receipt-field="total-vat"></span>
                                                </div>
                                                <div class="receipt-total-row receipt-total-row--emphasis">
...
@section('scripts')
	...
	<script>
        ...
        const receiptDefaultAccountNumber = '9015 18 00393';
        ...
        function renderReceiptModal(fields) {
            ...
            receiptModal.find('[data-receipt-field="due-date"]').text(data.due_date_formatted || '');

            const accountNumber = data.account_number || receiptDefaultAccountNumber;
            receiptModal.find('[data-receipt-field="account-number"]').text(accountNumber);
            receiptModal.find('[data-receipt-field="kid-number"]').text(data.kid_number || '');

            const amountDue = data.amount_due_formatted || data.total_formatted || '';
            receiptModal.find('[data-receipt-field="amount-due"]').text(amountDue);
            ...
            const netTotal = data.net_total_formatted || data.price_formatted || data.total_formatted || '';
            receiptModal.find('[data-receipt-field="net-total"]').text(netTotal);

            const vatTotal = data.vat_total_formatted || data.total_vat_formatted || '';
            receiptModal.find('[data-receipt-field="total-vat"]').text(vatTotal);
