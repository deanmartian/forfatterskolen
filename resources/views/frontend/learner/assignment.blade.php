			...
			<div class="modal-body text-center" style="padding: 30px;">
				...
				<div style="background: #f8f9fa; border-radius: 8px; padding: 20px; text-align: left; margin-bottom: 20px;">
					...
					<ul style="list-style: none; padding: 0; margin: 0;">
						...
						<li style="padding: 6px 0;"><i class="fa fa-clock" style="color: #6c757d; width: 20px;"></i> Du får tilbakemelding innen <strong class="success-expected-finish">ca. 3 uker</strong></li>
