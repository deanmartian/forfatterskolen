...
@section('page_title', 'Markedsføring &rsaquo; Forfatterskolen')

@section('content')
    <div class="learner-container">
        <div class="container">
            @if($standardProject)
                <a href="{{ route('learner.marketing-download') }}" class="btn btn-brand mb-3">
    ...
    <script>
        $(".answerMarketingPlanBtn").click(function() {
            ...
            $.each(plan.questions, function(qk, question) {
                ...
                questions += "<textarea type='text' class='sp-input sp-textarea' name='arr[" + number + "][main_answer]' rows='5'>"
                    + answer + "</textarea>";
                questions += "<input type='hidden' class='sp-input' name='arr[" + number + "][main_question_id]'" +
                    " value='" + question.id + "'>";
                        ...
                        questions += "<div class='sub-questions ms-5'>";
                            $.each(question.sub_question_decoded, function(k, sub_question){
                                ...
                                questions += "<div class='sp-form-group'>";
                                    ...
                                    questions += "<textarea type='text' class='sp-input sp-textarea' name='arr[" + number + "][sub_answer][]' rows='5'>"
                                        + answer + "</textarea>";
                                questions += "</div>";
                            });
                        questions += "</div>";
