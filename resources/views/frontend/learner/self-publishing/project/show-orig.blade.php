                ...
                <div class="col-md-12 dashboard-course no-left-padding">
                    <div class="card global-card">
                        <div class="card-header">
                            ...
                            {{-- <a href="{{ route('learner.service.order', [$project->id, 3]) }}" class="btn btn-primary float-end">
                                Order
                            </a> --}}
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card global-card mt-5">
                        <div class="card-header">
                            ...
                            {{-- <a href="{{ route('learner.service.order', [$project->id, 1]) }}" class="btn btn-primary float-end">
                                Order
                            </a> --}}
                        </div>
                    ...
                    <div class="card global-card mt-5">
                        <div class="card-header">
                            ...
                            {{-- <a href="{{ route('learner.service.order', [$project->id, 2]) }}" class="btn btn-primary float-end">
                                Order
                            </a> --}}
                        </div>
                        <div class="card-body py-0">
