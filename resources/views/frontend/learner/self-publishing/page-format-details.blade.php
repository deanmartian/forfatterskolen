...
@section('page_title', 'Page Format Details &rsaquo; Forfatterskolen')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 dashboard-course">
                <a href="{{ route('learner.self-publishing.page-format') }}" class="btn btn-light mb-3">
                    <i class="fa fa-arrow-left"></i> Back
                </a>

                <div class="card global-card">
                    <div class="page-toolbar mb-3">
                        <h3 class="float-start"><i class="fa fa-file-text-o"></i> Page Format</h3>

                        <button class="btn btn-primary float-end bookFormattingBtn" data-bs-toggle="modal"
