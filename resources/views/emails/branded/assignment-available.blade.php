...
<tr><td style="background:linear-gradient(135deg,#1c1917,#2a2520);padding:40px;text-align:center;">
    <p style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:1px;color:#ffd54f;margin:0 0 12px;font-family:-apple-system,sans-serif;">NY OPPGAVE</p>
    <h1 style="font-family:Georgia,serif;font-size:24px;font-weight:700;color:#fff;margin:0 0 8px;">{{ $assignmentTitle ?? 'Ny oppgave er klar!' }}</h1>
...
<tr><td style="background:#fff;padding:32px 40px;">
    <p style="font-size:15px;color:#5a5550;line-height:1.7;margin:0 0 20px;font-family:-apple-system,sans-serif;">
        Hei {{ $firstName ?? '' }}! En ny oppgave er tilgjengelig i {{ $courseName ?? 'kurset' }}.
    </p>
    ...
    <p style="font-size:14px;color:#5a5550;line-height:1.6;margin:0 0 24px;font-family:-apple-system,sans-serif;">{{ $assignmentDescription }}</p>
    @endif
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        <tr><td style="text-align:center;">
            <a href="{{ $portalUrl ?? config('app.url') . '/account/dashboard' }}" style="display:inline-block;padding:14px 32px;background:#862736;color:#fff;border-radius:8px;text-decoration:none;font-weight:700;font-size:15px;font-family:-apple-system,sans-serif;">Se oppgaven &rarr;</a>
        </td></tr>
    </table>
</td></tr>
@endsection
