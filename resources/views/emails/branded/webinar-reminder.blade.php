...
<tr><td style="background:#fff;padding:8px 40px 32px;text-align:center;">
    <p style="font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:1px;color:#862736;margin:0 0 12px;font-family:-apple-system,sans-serif;">Påminnelse</p>
    <h1 style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#1a1a1a;margin:0 0 8px;">{{ $reminderText }}</h1>
    ...
    <p style="font-size:12px;color:#8a8580;margin:16px 0 0;font-family:-apple-system,sans-serif;">
        Klikk på knappen over for å delta når webinaret starter.
    </p>
</td></tr>
@endsection
