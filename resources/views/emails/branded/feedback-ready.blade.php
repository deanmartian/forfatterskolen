...
<tr><td style="background:#fff;padding:32px 40px;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        <tr><td style="text-align:center;padding:8px 0;">
            <a href="{{ $feedbackUrl ?? config('app.url').'/learner/manuscripts' }}" style="display:inline-block;padding:14px 32px;background:#862736;color:#fff;border-radius:8px;text-decoration:none;font-weight:700;font-size:15px;font-family:-apple-system,sans-serif;">Se tilbakemeldingen &rarr;</a>
        </td></tr>
    </table>
</td></tr>
@endsection
