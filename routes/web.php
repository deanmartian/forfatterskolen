...
Route::domain($front)->group(function () {
    ...
    Route::middleware('logActivity')->group(function () {
        ...
        Route::prefix('course')->group(function () {
            ...
            Route::match(['get', 'post'], '/{id}/checkout/complete', [Frontend\ShopController::class, 'processOrder'])->name('front.course.process_order'); // Place Order
            Route::match(['get', 'post'], '/{id}/checkout/process-order', [Frontend\ShopController::class, 'processOrder']); // Legacy fallback
...
Route::domain($admin)->group(function () {
    ...
    Route::middleware('admin', 'logActivity')->group(function () {
        ...
        Route::post('/course-builder/create', [Backend\CourseController::class, 'courseBuilderCreate'])->name('admin.course.builder.create');
