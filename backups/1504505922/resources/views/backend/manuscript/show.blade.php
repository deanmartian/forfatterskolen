					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-5">
							<div class="pull-right">
								<button type="button" class="btn btn-success" data-toggle="modal" data-target="#assignEditorModal">Assign editor</button>
								<button type="button" class="btn btn-info" data-toggle="modal" data-target="#setGradeModal">Set grade</button>
								<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteManuscriptModal"><i class="fa fa-trash"></i></button> 
							</div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form method="POST" action="{{ route('admin.manuscript.assign_editor', $manuscript->id) }}">
      		{{csrf_field()}}
      		<div class="form-group">
      			<label>Editor</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form method="POST" action="{{ route('admin.manuscript.update', $manuscript->id) }}">
  			...
  			<button type="submit" class="btn btn-primary pull-right">Set grade</button>
  			<div class="clearfix"></div>
      	</form>
      </div>
    </div>
