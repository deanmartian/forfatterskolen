				...
				<div class="panel panel-default no-margin-bottom">
				  ...
				  <div class="panel-body">
					...
					<div class="text-center margin-bottom checkout-total">
						<h4>Totalt</h4>
						<span>{{ FrontendHelpers::currencyFormat($shopManuscript->price) }}</span>
					</div>
...
$(document).ready(function(){
	...
	var price = '{{ FrontendHelpers::currencyFormat($shopManuscript->price) }}';
	var split_payment_price = '{{ FrontendHelpers::currencyFormat($shopManuscript->split_payment_price) }}';
