...
Route::group([
    ...
    Route::group([
        ...
        Route::get('/assignment/{id}', 'LearnerController@assignmentShow')->name('learner.assignment.show'); // Assignment show Page
...
Route::group([
    ...
    Route::group([
        ...
        Route::post('course/{course_id}/assignment/{assignment_id}/add_learner', 'AssignmentController@addLearner')->name('admin.assignment.addLearner');
        Route::post('course/{course_id}/assignment/{assignment_id}/remove_learner/{id}', 'AssignmentController@removeLearner')->name('admin.assignment.removeLearner');
