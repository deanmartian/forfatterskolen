		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<textarea name="description" rows="12" id="description-ct" class="form-control" required>{{ $course['description'] }}</textarea>
				</div>
				<div class="form-group">
					<label>Course Plan</label>
					<textarea name="course_plan" rows="10" class="form-control">{{ $course['course_plan'] }}</textarea>
				</div>
			</div>
		</div>
	</div>
