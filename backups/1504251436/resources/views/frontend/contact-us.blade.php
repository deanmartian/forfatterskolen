...
<div class="container margin-bottom">
	<div class="row">
		...
		<div class="col-sm-8">
			...
			<p>
				Grunnlegger og rektor for skolen er Kristine Storli Henningsen, som er en suksessfull skjønnlitterær, seriebok, sakprosa, spennings- og selvhjelpsforfatter på henholdsvis Gyldendal Forlag, Cappelen Damm, Schibsted, Juritzen og Flux. Til sammen har hun utgitt 26 bøker, og debutromanen I skyggen av store trær er solgt til flere land.
			</p>
			<p>
			...
			<p>
				Skolens rektor står bak den populære bloggen <a href="http://www.antisupermamma.no" class="text-theme">Antisupermamma</a>, som har over 20 00 følgere hver uke og har vært i en rekke medier de siste årene. Hun er også fast familieblogger for VG.
			</p>
			<p>
	...
	<div class="row">
		...
		<div class="col-sm-5">
			<form method="POST" action="">
				...
				<div class="form-group">
					<input type="email" class="form-control" name="email" placeholder="Epost Addresse" required>
				</div>
				<div class="form-group">
